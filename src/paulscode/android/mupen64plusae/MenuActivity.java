        ...
        OnSharedPreferenceChangeListener
{
    ...
    private void refreshViews()
    {
        ...
        PrefUtil.enablePreference( this, SCREEN_SETTINGS_GAME, isValidGame );
        ...
        CharSequence title;
        if( mUserPrefs.selectedGameHeader.name == null )
            title = getString( R.string.screenSettingsGameEmpty_title );
        else
            title = getString( R.string.screenSettingsGame_title, mUserPrefs.selectedGameHeader.name.trim() );
        findPreference( SCREEN_SETTINGS_GAME ).setTitle( title);
    }
